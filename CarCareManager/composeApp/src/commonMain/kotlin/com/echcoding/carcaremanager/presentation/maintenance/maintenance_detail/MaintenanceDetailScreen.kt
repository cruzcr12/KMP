...
fun MaintenanceDetailScreenRoot(
    viewModel: MaintenanceDetailViewModel = koinViewModel(),
    onBackClick: () -> Unit
){
    ...
    Scaffold(
        ...
        topBar = {
            DetailTopBar(
                ...
                actions = {
                    if(state.isEditing){
                        IconButton(onClick = { onAction(MaintenanceDetailAction.OnDeleteClick(state.maintenance?.id)) }){
        ...
        bottomBar = {
            DetailBottomBar(
                onSaveButtonClick = { onAction(MaintenanceDetailAction.OnSaveClick) },
                ...
                DetailDateField(
                    ...
                    onSelectedDate = { selectedDate ->
                        ...
                        if(selectedDate != null){
                            onAction(MaintenanceDetailAction.OnInitialDateChange(selectedDate))
                        }
                    },
